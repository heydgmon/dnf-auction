 ...
 * ══════════════════════════════════════════════════════
 *
 * 원인: AuctionRow 함수가 AuctionSearchPanel보다 뒤에 정의되어 있거나,
 *       패치 적용 시 AuctionRow가 삭제/이동되어 참조 불가.
 *
 * 해결: page.tsx에서 기존 /* ═══ 경매장 ═══ */ 주석부터
 *       AuctionRow 함수 끝까지를 통째로 아래 코드로 교체하세요.
 *
 * 교체 범위:
 *   시작: /* ═══ 경매장 ═══ */
 *   끝:   AuctionRow 함수의 닫는 중괄호 }); } 까지
 *         (그 다음은 // === 시세 === 또는 AuctionSoldPanel)
 */
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
              ...
              <div style={{ flex: 1, background: "rgba(0,0,0,0.25)", borderRadius: 10, padding: "12px" }}>
                ...
                {pkgData.loading ? (
                  ...
                  <>
                    <div style={{ fontSize: 20, fontWeight: 800, color: "#60A5FA", letterSpacing: "-0.02em" }}>{cashEquivalent.toLocaleString()}</div>
          ...
          {!pkgData.loading && pkgData.lowestPrice > 0 && (
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                ...
                <div>
                  <div style={{ fontSize: 14, fontWeight: 800, letterSpacing: "-0.02em", color: isBuyNow ? "#34D399" : "#F87171" }}>
              ...
              <div style={{
                display: "flex", gap: 8, borderRadius: 8, padding: "10px 12px",
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 14, fontWeight: 700, color: isBuyNow ? "#34D399" : "#F87171" }}>{cashEquivalent.toLocaleString()}원</div>
                </div>
                ...
                <div style={{ flex: 1, textAlign: "right" }}>
                  ...
                  <div style={{ fontSize: 14, fontWeight: 700, color: "#94A3B8" }}>{SERA_SHOP_PRICE.toLocaleString()}원</div>
                </div>
              </div>
            </div>
          )}
